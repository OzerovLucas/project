  ...
  return (
    <header
      className={cn(
        ...
        scrolled &&
          "bg-white shadow-sm dark:bg-gray-950 dark:text-gray-50 border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:border-border"
      )}
    >
