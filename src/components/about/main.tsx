          ...
          <Card className="p-10">
            ...
            <div className="card-body space-y-4">
              <p>
                ...
                quantity. We manufacture the highest, quality, and standard
                Brazilian products. The prices and efficiency of our products
                are extremely favorable for the end buyers and end users. The
